...
const s = {
  ...
  forgotWrap: { textAlign: "right", margin: "8px 0 14px" },
  forgot: {
    fontSize: "0.48rem",
    color: "#6c63ff",
    cursor: "pointer",
...
function Field({ label, type = "text", placeholder, icon, value, onChange, error }) {
    ...
    <div style={s.fieldGroup}>
      ...
      <div style={s.fieldWrap}>
        ...
        <input
          ...
          onFocus={(e) => (e.target.style.borderColor = error ? "#ef4444" : "#6c63ff")}
          onBlur={(e) => (e.target.style.borderColor = error ? "#ef4444" : "#2a2a35")}
        />
        {isPass && (
    ...
    <div style={s.wrapper}>
      <div style={s.container}>
        ...
        <div style={s.badge}>
          ...
          <span style={s.badgeText}>Secure Access</span>
        </div>

        <h1 style={s.title}>Welcome back</h1>
        <p style={s.subtitle}>
          Sign in to your control panel to manage deployments and monitor systems.
        </p>
        ...
        <p style={s.footer}>
          ...
          <span style={s.link} onClick={onSwitchToRegister}>Register →</span>
        </p>
      </div>
    </div>
  );
